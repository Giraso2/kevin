        ...
        <div className="error-content" style={{
          ...
          <div className="error-message">
            ...
            <div className="error-url">
              ...
              <button onClick={() => navigator.clipboard.writeText(window.location.href)} className="copy-url-btn">
          ...
          <div className="countdown-timer">
            <div className="timer-circle">
              ...
              <div className="timer-text">
                ...
                <span className="countdown-label">Redirecting</span>
              </div>
            </div>
            <p>You will be redirected to <Link to="/">homepage</Link> in {countdown} seconds</p>
            <button onClick={() => setCountdown(0)} className="stop-redirect">
              <i className="fas fa-times-circle"></i> Stop Redirect
            </button>
          </div>
          ...
          <div className="fun-fact">
            ...
            <div>
              ...
              <p>The 404 error code was introduced to indicate that the requested page could not be found on the server. It's named after room 404 at CERN where the web was born!</p>
            </div>
          </div>

          {/* Footer */}
          <div className="error-footer">
            <p>© 2024 ESSA Nyarugunga School | All rights reserved</p>
